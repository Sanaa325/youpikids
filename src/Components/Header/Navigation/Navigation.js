    ...
    return (
        <div className="navigation-container">
            ...
            <ul className={`Navigation ${mobileMenuOpen ? 'active' : ''}`}>
                ...
                <NavigationItem to="/activites">Activités</NavigationItem>
                <NavigationItem to="/anniversaires">Anniversaires</NavigationItem>
                <NavigationItem to="/restaurant">Restaurant</NavigationItem>
                <NavigationItem to="/groupes">Groupes</NavigationItem>
